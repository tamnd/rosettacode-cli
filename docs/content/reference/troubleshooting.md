...
Most of these come down to network reality or how rosettacode serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

rosettacode rate-limits like any public site. rc already paces
...
Where a surface is gated, rc reads a cookie or token you supply
...
`rc`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what rc actually did
